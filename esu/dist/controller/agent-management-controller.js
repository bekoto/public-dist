...
let AgentManagementController = class AgentManagementController {
    ...
    addAgent(data, token, tokenb) {
        console.log("aaa", data, tokenb.replace('Bearer ', ''));
...
__decorate([
    ...
    __param(1, (0, common_1.Headers)('x-app-token')),
    __param(2, (0, common_1.Headers)('Authorization')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [agent_dto_1.AgentDto, String, String]),
