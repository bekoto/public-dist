...
class AgentDto {
    toEntity() {
        ...
        if (this.idCentre) {
            ...
            c.id = new mongoose_1.default.Schema.Types.ObjectId(this.idCentre);
            a.centre = c;
        }
...
__decorate([
    (0, uniqueagentconstrainte_service_1.UniqueAgent)(),
    __metadata("design:type", String)
], AgentDto.prototype, "code", void 0);
__decorate([
    (0, etablissement_constrainte_1.EtablissementMustExist)(),
    __metadata("design:type", String)
], AgentDto.prototype, "idEtabilissement", void 0);
