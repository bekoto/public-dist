...
export declare class UniqueEtablissementValidatorService implements ValidatorConstraintInterface {
    configServ: ConfigService;
    constructor(configServ: ConfigService);
    validate(value: string, validationArguments?: ValidationArguments): boolean | Promise<boolean>;
    defaultMessage?(validationArguments?: ValidationArguments): string;
}
export declare function UniqueEtablissementMustExist(validationOptions?: ValidationOptions): (object: any, propertyName: string) => void;
