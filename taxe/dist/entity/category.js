...
exports.categoryPriceSchema = exports.CategoryPrice = exports.categoryUserSchema = exports.CategoryUser = void 0;
...
let CategoryPrice = class CategoryPrice {
};
__decorate([
    (0, mongoose_1.Prop)(),
    __metadata("design:type", String)
], CategoryPrice.prototype, "libelle", void 0);
__decorate([
    (0, mongoose_1.Prop)(),
    __metadata("design:type", String)
], CategoryPrice.prototype, "code", void 0);
CategoryPrice = __decorate([
    (0, mongoose_1.Schema)()
], CategoryPrice);
exports.CategoryPrice = CategoryPrice;
exports.categoryPriceSchema = mongoose_1.SchemaFactory.createForClass(CategoryPrice);
