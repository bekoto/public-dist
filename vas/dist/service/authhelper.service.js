...
let AuthhelperService = class AuthhelperService {
    ...
    generateToken(user) {
        ...
        console.debug("ffffff", uF, user, "ppp", user.application.id.toString(), user.application._id.toString());
        return this.jwt.sign({ id: (_a = user.id) !== null && _a !== void 0 ? _a : uF._id.toString(), email: user.email, app: user.application._id.toString() });
    }
